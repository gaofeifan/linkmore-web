...
layui.use(['layer','msg','form', 'common','validate','datatable','laydate'], function() {
	...
	var datatable = layui.datatable.init({
		id:'app-version-table',
		url:'/admin/base/app_version/list', 
		key:'id',
		columns:[ 
	...
	$('#delete-button').bind('click',function(){
		...
		layui.msg.confirm('您确定要删除',function(){
			layui.common.ajax({
				url:'/admin/base/app_version/delete',
	...
	var addInit = function(validate,lindex){   
		...
		$('#app-version-add-button').bind('click',function(){
        	if(validate.valid()){  
        		layui.common.ajax({
        			url:'/admin/base/app_version/save',
    ...
    $('#add-button').bind('click',function(){
    	...
    	valid.rules = {
    		name:{
    			...
    			required: true,
    			remote:{
    				url:"/admin/base/app_version/check",  
    				data:{
    					property:"name",
    					value:function(){return $('#app-version-add-form input[name=name]').val();},
    ...
    var editInit = function(validate,lindex){  
		...
		$('#app-version-update-button').bind('click',function(){
        	if(validate.valid()){  
        		layui.common.ajax({
        			url:'/admin/base/app_version/update',
        			data:$('#app-version-edit-form').serialize(),
        			success:function(res){
        				if(res.success){
        					layui.layer.close(lindex);
        					layui.msg.success(res.content);
    ...
    $('#edit-button').bind('click',function(){
    	...
    	param.title = '编辑信息'; 
    	var valid = new Object();
    	valid.id = "app-version-edit-form";
    	valid.rules = {
    		name:{
    			rangelength:[1,32] ,
    			required: true,
