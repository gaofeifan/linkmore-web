...
layui.use(['layer','msg','form', 'common','datatable','laydate'], function() {
	...
	var datatable = layui.datatable.init({
		id:'lock-operate-table',
		url:'/admin/admin/lock_operate/list', 
		key:'id',
		columns:[ 
				...
				sTitle: '来源',
	          	...
	          	mRender:function(mData,type,full){
	          		...
	          		switch(mData){
		          		...
		          		case 2:html += 'APP电池更换';break;
		          		case 3:html += 'APP设备更换';break;
		          		case 4:html += 'APP车区管理';break;
	          		}
	          		return html;
	          	}
			},
			{
				sTitle: '操作',
	          	...
	          	mRender:function(mData,type,full){
	          		var html = '';
	          		switch(mData){
	          			case 1:html += '<label style="color:green;">升起</label>';break;
		          		case 2:html += '<label style="color:red;">降下</label>';break;
	          		}
	          		return html;
	          	}
			},
    ...
    var operation_log = function showData(logId,callback){
    	layui.common.ajax({
			url:'/admin/admin/lock_operate/detail',
    ...
    var detailInit = function(validate,lindex){
    	operation_log(logId,function(data){
    		var list = data;
    		layui.common.set({
    			id:'lock-operate-detail-form',
    			data:list[0]
    		});
    		$('#lock-operate-detail-form input[name=createTime]').val(dataf(list[0].createTime));
    		$('#lock-operate-detail-form select').attr('disabled',true);
    		$('#lock-operate-detail-form input').attr('disabled',true);
    		form.render('select');
    	});
    	$('#lock-operate-cancel-detail-button').bind('click',function(){
	...
	function operationLog(){
    	...
    	valid.id = "lock-operate-detail-form";
    	param.width = 650;
	...
	$('#export-button').bind('click',function(){
        ...
        var url = '/admin/admin/lock_operate/export';
